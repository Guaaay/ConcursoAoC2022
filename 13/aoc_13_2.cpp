...
int main(){
    ...
    for(int i = 0; i < all.size(); i++){
        if(all[i].elements.size() == 1 
        && all[i].elements[0].elements.size() == 1 
        && all[i].elements[0].elements[0].val == 2){
            index1 = i+1;
        }
        if(all[i].elements.size() == 1 
        && all[i].elements[0].elements.size() == 1 
        && all[i].elements[0].elements[0].val == 6){
            result = (i+1) * index1;
        }
    }
